...
/**
 * This interface provides only property getters, and adds the {@code comment} attribute.
 *
 * @param <K> Key type.
 * @param <V> Value type.
 *
 ...
 * @version 1.0.20
 */
public interface ImmutablePropertyComment<K, V> extends ImmutableProperty<K, V> {
